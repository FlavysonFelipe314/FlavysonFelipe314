## Hello world :wave:, I'm [aqui vai seu nome]:

I’m a *FullStack and Mobile Software Engineer*, always eager to learn and grow in my craft.

## Techs:

*:pushpin:Front-end:* [aqui vão suas tecnologias de front-end]

*:pushpin:Mobile:* [aqui vão suas tecnologias de mobile]

*:pushpin:Back-end:* [aqui vão suas tecnologias de back-end]

*:test_tube:Tests:* [aqui vão suas ferramentas de testes]

*:hammer_and_wrench:Tools:* [aqui vão suas ferramentas/devops]

*:paintbrush:UX/UI:* [aqui vão suas ferramentas de design]

*:books:Libs:*  
- [aqui vão suas bibliotecas de estilização e UI]  
- [aqui vão seus frameworks de servidor]  
- [aqui vão seus ORMs e bancos de dados]  
- [aqui vão suas ferramentas de documentação ou segurança]

*:mag_right:Studying:* [aqui vão suas tecnologias que está estudando]
